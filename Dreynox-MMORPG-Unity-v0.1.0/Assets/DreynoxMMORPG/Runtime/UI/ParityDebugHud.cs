...
namespace Dreynox.Mmorpg.UI
{
    public sealed class ParityDebugHud : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Box(new Rect(14, 14, width, 178), "Dreynox MMORPG · Client Parity Sandbox");
