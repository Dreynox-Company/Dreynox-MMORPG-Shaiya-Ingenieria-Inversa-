    ...
    public static class NativeWorldHudBuilder
    {
        public static NativeWorldHud Create(CanonicalClientCorpus corpus)
        {
            ...
            string[] paths={"statusminibar/player_bar_bg.tga","statusminibar/class_attack_fighter.tga",
                "slot/main_slot_1.tga","npctalk/talk1_bg.tga","minimap/minimap_1.tga",
            ...
            for(int i=0;i<paths.Length;i++)
            {
                ...
                importer.mipmapEnabled=false;importer.alphaIsTransparency=false;importer.npotScale=TextureImporterNPOTScale.None;
            ...
            hud.SetPresentationSkin(NativeHudSkinImporter.Import(corpus));
            return hud;
        }
    }
}
